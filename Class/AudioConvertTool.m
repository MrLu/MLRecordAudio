...
#import "fat-lame/include/lame/lame.h"

@interface AudioConvertTool ()
@property (nonatomic, assign) BOOL stopRecord;
@end

@implementation AudioConvertTool
...
+ (instancetype)sharedInstance {
    static AudioConvertTool *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[AudioConvertTool alloc] init];
    });
    return instance;
}
